...
export const TEXT = {
	en: {
			...
			_components: {
				...
				_Settings: {
					...
					_AutoReload: {
						...
						WWMMMsg: "Reload when GIMM is focused ★",
					...
					_LaunchGame: { LaunchMsg1: "Launches the game via XXMI", LaunchMsg2: "when you start GIMM" },
					HotKey: "Hotkey",
					_HotKey: {
		...
		_Tutorial: {
			...
			p8: {
				Title: "Viewing Mods from a link",
				Paste: "Paste anywhere in the GIMM window",
		...
		_LeftSideBar: {
			_components: {
				...
				_Settings: {
					...
					LaunchGame: "启动游戏",
					_LaunchGame: { LaunchMsg1: "通过 XXMI 启动游戏", LaunchMsg2: "当您启动 GIMM 时" },
					HotKey: "热键",
					_HotKey: {
						HKMsg1: "仅在自动重载设置为",
						HKMsg2: "或",
	...
	ru: {
			...
			_components: {
				...
				_Settings: {
					...
					_AutoReload: {
						...
						WWMMMsg: "Перезагружать при фокусе на GIMM ★",
					...
					_LaunchGame: { LaunchMsg1: "Запускает игру через XXMI", LaunchMsg2: "при запуске GIMM" },
		...
		_Tutorial: {
			...
			p8: {
				Title: "Просмотр модов по ссылке",
				Paste: "Вставьте в любом месте окна GIMM",
		...
		_LeftSideBar: {
			_components: {
				...
				_Settings: {
					...
					LaunchGame: "ゲーム起動",
					_LaunchGame: { LaunchMsg1: "XXMIを介してゲームを起動", LaunchMsg2: "GIMMを起動する時" },
					HotKey: "ホットキー",
					_HotKey: {
						HKMsg1: "自動リロードが",
		...
		_LeftSideBar: {
			_components: {
				...
				_Settings: {
					...
					LaunchGame: "게임 실행",
					_LaunchGame: { LaunchMsg1: "XXMI를 통해 게임 실행", LaunchMsg2: "GIMM을 시작할 때" },
					HotKey: "단축키",
					_HotKey: {
						HKMsg1: "자동 새로고침이",
